	...
	function Schedule (opt) {
		...
		var init = function () {
			var scheduleHd = '<div class="schedule-hd">'+
								...
								'</div>'+
							'</div>'
			var scheduleWeek = '<ul class="week-ul ul-box wul">'+
									'<li>日</li>'+
									'<li>一</li>'+
									'<li>二</li>'+
									'<li>三</li>'+
		...
		var render = function () {
			...
			for(var i = 0; i < total; i++){
				if(i<startWeek){
					...
					eleTemp.push('<li class="current-month"  onclick="job()" ><span title='+nowDate+' class="currentDate dayStyle '+addClass+'">'+(i+1-startWeek)+'</span></li>')
				}else{
